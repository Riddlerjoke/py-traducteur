from src.dto.connexion import Connexion
from src.model.prompt import Prompt
from src.model.utilisateur import Utilisateur


class ServiceTraducteur(Connexion):
    ...
    def lister_prompts(cls, utilisateur: int):
        ...
        for prompt_lu in cls.cursor:
            prompt = Prompt(atraduire=prompt_lu["text_in"], traduction=prompt_lu["text_out"],
                            version=prompt_lu["version"], utilisateur=prompt_lu["utilisateur"])
